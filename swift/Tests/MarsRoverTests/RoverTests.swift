...
final class RoverTests: XCTestCase {
    func testRoverMovements() {
        let testCases = [
            ...
            ("1 2 \(RoverState.bearingSouth)", "L", "1 2 \(RoverState.bearingEast)"),
            ("1 2 \(RoverState.bearingEast)", "L", "1 2 \(RoverState.bearingNorth)"),
            ("1 2 \(RoverState.bearingNorth)", "R", "1 2 \(RoverState.bearingEast)"),
            ("1 2 \(RoverState.bearingEast)", "R", "1 2 \(RoverState.bearingSouth)"),
            ...
            ("1 2 \(RoverState.bearingEast)", "M", "2 2 \(RoverState.bearingEast)"),
            ...
            ("3 3 \(RoverState.bearingEast)", "MMRMMRMRRM", "5 1 \(RoverState.bearingEast)")
        ]
